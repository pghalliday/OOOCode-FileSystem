...
OOOTest(OOOPath)
{
	...
	OOOCheck(O_strcmp(TEST_DIRECTORY1, OOOCall(pPath1, toString)) == 0);
	OOOCheck(O_strcmp(TEST_DIRECTORY, OOOCall(pPath3, toString)) == 0);
	...
	OOOCheck(O_strcmp(szAbsolutePath, OOOCall(pRelativePath, toString)) == 0);
